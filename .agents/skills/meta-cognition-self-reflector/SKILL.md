...
description: Use this for Cyber-Immunizer high-risk design, roadmap, experiment-interpretation, phase-transition, fitness-function, mutation-boundary, structured-rules integration, and value-claim decisions. It forces premise inspection, evidence grading, refutation, alternatives, synthesis, uncertainty disclosure, and next verification steps. Do not use for routine code edits, simple PR reviews, or CI fixes.
---
## Purpose
